...
public class CommonDAOInterfacePlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        if (stringHasValue(daoTargetPackage)) {
            ...
            mapperInterface.addJavaDocLine(" * @author ChenHao");
            mapperInterface.addJavaDocLine(" * " + "MyBatisBaseMapper，由MybatisGenerator自动生成请勿修改");
    ...
    public boolean clientGenerated(Interface interfaze,
        ...
        interfaze.addJavaDocLine(" * @author ChenHao");
        interfaze.addJavaDocLine(" * " + interfaze.getType().getShortName() + "继承基类，由MybatisGenerator自动生成请勿修改");
        interfaze.addJavaDocLine(" */");
